"""
Inspired from Tensorflow NMT model implementation
"""
...
def add_arguments(parser):
    ...
    # INFO : learning rate changed from 1.0 -> 0.0001
    parser.add_argument(
        "--learning_rate",
        type=float,
        default=0.0001,
    ...
    # INFO : num_training_steps changed from 12000 -> 10000
    parser.add_argument(
        "--num_train_steps", type=int, default=10000, help="Num steps to train."
    )
    parser.add_argument(
    ...
    # initializer
    # INFO : init_op changed from uniform -> glorot_normal
    parser.add_argument(
        "--init_op",
        type=str,
    ...
    # Sequence lengths
    # INFO : src_max_len changed from 50 -> 300
    parser.add_argument(
        "--src_max_len",
        type=int,
        default=300,
    ...
    # INFO : src_max_len_infer changed from None -> 300
    parser.add_argument(
        "--src_max_len_infer",
        type=int,
        default=300,
    ...
    # INFO : batch_size changed from 128 -> 2
    ...
    # INFO : num_buckets changed from 5 -> 0
    parser.add_argument(
        "--num_buckets",
        type=int,
        default=0,
    ...
    # BPE (Extra added)
    parser.add_argument(
        "--bpe_delimiter", type=str, default=None, help="Set to @@ to activate BPE"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="ID of the GPU to start allocating from.",
    )
    parser.add_argument(
    ...
    # INFO : random_seed changed from None -> 285
    parser.add_argument(
        "--random_seed",
        type=int,
        default=285,
    ...
    # INFO : beam_width changed from 0 -> 3
    parser.add_argument(
        "--beam_width",
        type=int,
        default=3,
...
def extend_hparams(hparams):
    ...
    # INFO : Source Vocab not needed as source is a video
    # # Source vocab
